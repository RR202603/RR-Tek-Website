const languages = {
    en: {
        ...
        about: {
            ...
            description: "Changsha RR-Tek Technology Co., Ltd., established in April 2021 in Changsha, Hunan, focuses on the development and application of intelligent materials design software and scientific databases. Main services include scientific software development and sales, thermodynamic and thermophysical database development, AI- and ML-assisted materials R&D, technical training and academic conferences, as well as new materials technology development and engineering consulting. The company has a team of 15 PhDs and 5 Masters, and scientific advisors from the USA, Germany, France, Austria, and Hungary. With robust software development and delivery processes, all software products are tested for reliability and compliance, including ICALPHAD (2026a), CALTPP (2026a), MID-Meso (2026a), MID-Nano (2026a), and CPCP (2026a), with third-party test reports at B-level or above. Clients include Huawei, Chinese Academy of Sciences, Northwestern Polytechnical University, Hyperion (USA), and 33 other domestic and international institutions. The company has established a strong reputation in intelligent materials design and engineering applications, demonstrating continuous innovation and successful technology transfer.",
        ...
        contact: {
            ...
            address: "Address: Room 806, Building 5, Aux Plaza, Yuelu District, Changsha, China",
            emailTitle: "Email",
            email: "Email: rrui_info@163.com",
            cooperationTitle: "Cooperation",
            cooperationText: "We welcome research collaboration, product inquiries, and technical exchange.",
            formTitle: "Online Message",
            formName: "Name",
            formEmail: "Email",
            formCompany: "Organization / Company",
            formMessage: "Message",
            formSubmit: "Submit",
            placeholderName: "Please enter your name",
            placeholderEmail: "Please enter your email",
            placeholderCompany: "Please enter your organization or company name",
    ...
    zh: {
        ...
        about: {
            ...
            description: "长沙锐睿科技有限公司成立于2021年4月，位于湖南省长沙市。公司专注于材料智能设计软件和科学数据库的开发及应用，主营业务涵盖科研软件开发与销售、材料热力学与热物性等科学数据库开发、AI与机器学习辅助材料研发、行业技术培训与学术会议组织，以及新材料技术开发与工程咨询等科技服务。公司拥有一支由 15 位博士及5位硕士组成的专业软件及科学数据库研发团队，并聘请美、德、法、奥地利和匈牙利教授为公司科学顾问。已建立完善的软件研发过程管理与交付验收机制，确保产品质量与服务可靠性。目前，基于最新的物理、材料学理论及公司自主研发的算法，公司自主研发了独立于欧美的软件，包括 ICALPHAD (Intelligent CALculation of PHAse Diagrams, 2026a)、CALTPP (CALculation of ThermoPhysical Properties, 2026a)、MID-Meso (Microstructure Intelligent Design Mesoscale, 2026a)、MID-Nano (Microstructure Intelligent Design Nanoscale, 2026a)和CPCP (Crystal Plasticity Calculation Package, 2026a)。所有软件在交付时可提供由具备资质的第三方软件测评机构出具的自主可控测试报告，自主可控等级达到 B 级及以上。在市场应用方面，公司客户覆盖华为、中国科学院、西北工大、美国 HYPERION公司等国内外高校、科研院所与公司33家，已在材料智能设计与工程应用领域形成优秀口碑，具备持续技术创新与成果转化能力。",
            missionTitle: "我们的使命",
        ...
        contact: {
            tag: "Contact",
            title: "联系我们",
            description: "欢迎与我们联系，了解产品信息、数据库服务及项目合作机会。",
            addressTitle: "办公地址",
            address: "地址：长沙市岳麓区奥克斯广场5栋806室",
            emailTitle: "电子邮箱",
            email: "邮箱：rrui_info@163.com",
            cooperationTitle: "合作咨询",
            cooperationText: "欢迎科研合作、产品咨询与技术交流。",
            formTitle: "在线留言",
            formName: "姓名",
            formEmail: "邮箱",
            formCompany: "单位 / 公司",
            ...
            placeholderCompany: "请输入您的单位或公司名称",
...
function updateBrandText() {
    ...
    if (brandText) {
        brandText.textContent =
            currentLanguage === "zh"
                ? "长沙锐睿科技有限公司"
                : "Changsha RR-Tek Technology Co., Ltd.";
    }
}
